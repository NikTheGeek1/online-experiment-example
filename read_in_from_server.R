...
# ssh -L 1111:localhost:5432 hdmpplsedac@chost4.is.ed.ac.uk

#Then you should be able to connect via an ssh port
drv <- dbDriver("PostgreSQL")
con <- dbConnect(drv, dbname = 'hdmpplsedac_database',
                  host = 'localhost', port = 1111,
                  password = 'testpassword123',
                  user = 'hdmpplsedac_database_user')
...
save(file='example_data.rdata', df.sw, df.tw)
